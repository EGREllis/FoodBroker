<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr><td><h3><input type="checkbox" name="remember" />Remember password</h3></td>
                <td><h3><a href="forgot_password.html">Forgot password?</a></h3></td></tr>
            <tr><td colspan="2"><input type="submit" value="Sign In" /></td></tr>
            <tr><td colspan="2"><h3>Don't have an account? <a href="create_account.html">Create Account</a></h3></td></tr>
        </table>
        </form>
    </body>
</html>